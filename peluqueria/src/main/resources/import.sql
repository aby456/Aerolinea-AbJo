...
INSERT INTO TBL_USERS(ID, NAMES,PASSWORDS, ENABLEDS) VALUES (1, 'Diego', '$2a$10$sBXalkjkcM84e.OoZoJoO.EUXO7WVr9oQQc.2cXExiiKoMFqq.YVW', 1);
INSERT INTO TBL_ROLES(ID, ROLES, USER_ID) VALUES (1, 'ROLE_TEACHER', 1); 
INSERT INTO TBL_ROLES(ID, ROLES, USER_ID) VALUES (2, 'ROLE_STUDENT', 1);
